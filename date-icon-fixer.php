...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('flatpickr-css', $plugin_url . 'css/flatpickr.min.css');

    $theme = get_option('date_icon_fixer_theme');
    if (!empty($theme)) {
        wp_enqueue_style('flatpickr-theme', $plugin_url . 'css/themes/' . esc_attr($theme) . '.css');
    }

    wp_enqueue_script('flatpickr-js', $plugin_url . 'js/flatpickr.min.js', [], null, true);
    wp_enqueue_script('init-flatpickr', $plugin_url . 'js/init-flatpickr.js', ['flatpickr-js'], null, true);
...
?>
    <div class="wrap">
        <div class="head">
            <div class="text-svg">
                ...
                <h1>Date Icon Fixer <span class="version">v1.2</span></h1>
            </div>
        ...
        <p>Lean, UX-driven, and extensible, yet it doesn’t depend on any libraries. There’s minimal UI but many themes. Rich, exposed APIs and event system make it suitable for any environment.</p>
        <br>
        <div>
            <div class="text-svg">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">For custom theme's you have to add your own css or make your own theme.</p>
                        <p class="description"><span class="text-heading">- </span>Path: /plugins/date-icon-fixer/css/themes/...</p>
                        <p class="description"><span class="text-heading">- </span>Wrapper class: flatpickr-calendar</p>
        ...
        <div class="footer">
            ...
            <p>Plugin is open source and available on <a href="">GitHub</a>
        </div>
    ...
    <style>
        ...
        select {
            ...
            background: linear-gradient(135deg, transparent 50%, #00D992 50%) no-repeat right 1rem center !important;
            background-size: 0.65em 0.65em !important;
        ...
        .button-primary:hover {
            ...
            color: #080F11 !important;
        }

        .button-dateicon-fixer {
            background: #080F11;
            color: #00D992;
            border: 1px solid #00D992;
            padding: 10px 20px;
